...
define([
    ...
    /**
     * Builds an HTML input list (which is never injected into the DOM) to be sent to Decidir SDK
     *
     * Decidir SDK expects to receive a list of inputs, so we'll build it on-the-fly
